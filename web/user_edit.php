...
<form class="form-horizontal" method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" required="required" class="form-control" name="user[firstname]" placeholder="Firstname" value="<?=$member['firstname']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" required="required" class="form-control" name="user[lastname]" placeholder="Lastname" value="<?=$member['lastname']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[nickname]" placeholder="Nickname" value="<?=$member['nickname']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[tel]" placeholder="Telephone" value="<?=$member['tel']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[address1]" placeholder="Address1" value="<?=$member['address1']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[address2]" placeholder="Address2" value="<?=$member['address2']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[city]" placeholder="City" value="<?=$member['city']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[province]" placeholder="Province" value="<?=$member['province']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[zip]" placeholder="Zip" value="<?=$member['zip']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[chronic]" placeholder="If any, please identify." value="<?=$member['chronic']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[allergies]" placeholder="If have please identify." value="<?=$member['allergies']?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                ...
                <input type="text" class="form-control" name="user[food_other]" id="food_other" placeholder="Pease identify." value="<?=$member['food_other']?>"<?=$member['food']!=99?' style="display: none;"':''?>>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" name="user[position]" placeholder="Position" value="<?=$member['position']?>">
            </div>
        </div>
