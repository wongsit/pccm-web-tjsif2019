		...
		<nav class="navbar navbar-inverse navbar-fixed-top topnav" role="navigation">
            <div class="container topnav">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand topnav" href="index.php">TJ-SIF-2019</a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-info">
			                <div class="panel-heading">TJ-SIF 2019 Register</div>
...
<form class="form-horizontal" method="post">
    <fieldset>
        ...
        <div class="form-group">
            <label for="inputEmail" class="col-lg-3 control-label"><b>Your Email*</b></label>
            <div class="col-lg-9">
