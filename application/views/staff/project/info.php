  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="row">
        ...
        <div class="col-sm-10">
          <a href="<?php echo base_url(); ?>staff/projects/index" class="btn btn-outline-success  btn-lg  btn-block">View projects list</a>
        </div>
          <div class="col-sm-10">
            <a href="<?php echo base_url(); ?>staff/projects/upload_picture/<?php echo $project->id; ?>" class="btn btn-warning btn-lg btn-block">Change picture</a>
          </div>
          <div class="col-sm-10">
            <a href="<?php echo base_url(); ?>staff/projects/edit/<?php echo $project->id; ?>" class="btn btn-primary btn-lg btn-block">Edit infomation</a>
          </div>
          <div class="col-sm-10">
            <?php if($this->session->userdata('username') == 'w.khanchai@pccm.ac.th'){ ?>
            <a data-toggle="modal" data-target="#delete" href="#" class="btn btn-danger btn-lg btn-block">Delete this project</a>
          <?php } ?>
          </div>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file('tjsif2019-project-abstract-'.$project->id.'.docx') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download/<?php echo $project->id; ?>/tjsif2019-project-abstract-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-success disabled"><i class='far fa-file-word'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download/<?php echo $project->id; ?>/tjsif2019-project-abstract-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-success"><i class='far fa-file-word'></i> Download</a>
                      <?php } ?>
                    </td>
                    <td>
                        <a href="<?php echo base_url(); ?>staff/projects/upload_file/<?php echo $project->id; ?>/tjsif2019-project-abstract-<?php echo $project->id.'.docx'; ?>" class="btn btn-outline-primary"><i class='fas fa-cloud-upload-alt'></i> Upload</a>
                    </td>
                  </tr>
                  <tr>
                    <td>Abstract (.pdf)</td>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file('tjsif2019-project-abstract-'.$project->id.'.pdf') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download/<?php echo $project->id; ?>/tjsif2019-project-abstract-<?php echo $project->id.'.pdf'; ?>" target="_blank" class="btn btn-outline-success disabled"><i class='far fa-file-pdf'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download/<?php echo $project->id; ?>/tjsif2019-project-abstract-<?php echo $project->id.'.pdf'; ?>" target="_blank" class="btn btn-outline-success"><i class='far fa-file-pdf'></i> Download</a>
                      <?php } ?>
                    </td>
                    <td>
                        <a href="<?php echo base_url(); ?>staff/projects/upload_file/<?php echo $project->id; ?>/tjsif2019-project-abstract-<?php echo $project->id.'.pdf'; ?>" class="btn btn-outline-primary"><i class='fas fa-cloud-upload-alt'></i> Upload</a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file('tjsif2019-project-fullpaper-'.$project->id.'.docx') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-success disabled"><i class='far fa-file-word'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-success"><i class='far fa-file-word'></i> Download</a>
                      <?php }?>
                    </td>
                    <td>
                      <a href="<?php echo base_url(); ?>staff/projects/upload_file/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-<?php echo $project->id.'.docx'; ?>" class="btn btn-outline-primary"><i class='fas fa-cloud-upload-alt'></i> Upload</a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file('tjsif2019-project-fullpaper-'.$project->id.'.pdf') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-<?php echo $project->id.'.pdf'; ?>" target="_blank" class="btn btn-outline-success disabled"><i class='far fa-file-pdf'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projectst/download/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-<?php echo $project->id.'.pdf'; ?>" target="_blank" class="btn btn-outline-success"><i class='far fa-file-pdf'></i> Download</a>
                      <?php }?>
                    </td>
                    <td>
                        <a href="<?php echo base_url(); ?>staff/projects/upload_file/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-<?php echo $project->id.'.pdf'; ?>" class="btn btn-outline-primary"><i class='fas fa-cloud-upload-alt'></i> Upload</a>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="table-responsive">
              <h3 class="text-warning"><i class='far fa-edit'></i> <b>Professor comment</b></h3>
              <p>For commenting on this project, the professor can upload the file here. </p>
              <table class="table table-striped">
                <thead>
                  <tr>
                    <th>Document</th>
                    ...
                    <th>Last update</th>
                    <th>files</th>
                    <th>Upload(Operation staff only)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file_comment('tjsif2019-project-abstract-comment-'.$project->id.'.docx') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-abstract-comment-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-warning disabled"><i class='far fa-file-word'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-abstract-comment-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-warning"><i class='far fa-file-word'></i> Download</a>
                      <?php } ?>
                    </td>
                    <td>
                        <a href="<?php echo base_url(); ?>staff/projects/upload_file_comment/<?php echo $project->id; ?>/tjsif2019-project-abstract-comment-<?php echo $project->id.'.docx'; ?>" class="btn btn-outline-danger"><i class='fas fa-cloud-upload-alt'></i> Upload file comment</a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file_comment('tjsif2019-project-fullpaper-comment-'.$project->id.'.docx') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-comment-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-warning disabled"><i class='far fa-file-word'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-comment-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-warning"><i class='far fa-file-word'></i> Download</a>
                      <?php } ?>
                    </td>
                    <td>
                        <a href="<?php echo base_url(); ?>staff/projects/upload_file_comment/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-comment-<?php echo $project->id.'.docx'; ?>" class="btn btn-outline-danger"><i class='fas fa-cloud-upload-alt'></i> Upload file comment</a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file_comment('tjsif2019-project-abstract-edited-'.$project->id.'.docx') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-abstract-edited-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-info disabled"><i class='far fa-file-word'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-abstract-edited-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-info"><i class='far fa-file-word'></i> Download</a>
                      <?php } ?>
                    </td>
                    <td>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($this->Project_model->check_file_comment('tjsif2019-project-fullpaper-edited-'.$project->id.'.docx') == null) { ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-edited-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-info disabled"><i class='far fa-file-word'></i> Download</a>
                      <?php }else{ ?>
                        <a href="<?php echo base_url(); ?>staff/projects/download_comment/<?php echo $project->id; ?>/tjsif2019-project-fullpaper-edited-<?php echo $project->id.'.docx'; ?>" target="_blank" class="btn btn-outline-info"><i class='far fa-file-word'></i> Download</a>
                      <?php } ?>
                    </td>
                    <td>
                    </td>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">You are deletting <?php echo $project->name; ?><br/>. Are you sure delete it ?</div>
      <div class="modal-footer">
        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
        <a class="btn btn-primary"  href="<?php echo base_url(); ?>staff/projects/delete/<?php echo $project->id; ?>">OK</a>
      </div>
    </div>
  </div>
</div>
