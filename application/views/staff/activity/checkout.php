...
<div class="container">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="<?php echo base_url(); ?>staff/activity/export_checkout" target="_blank">Export excel</a>
    </div>
  </li>
</ul>
  ...
  <div class="row">
    <div class="col-sm-9">
      ...
      <?php if(isset($user)){ // ?>
          ...
          <?php } ?>
            ...
            <div class="col-sm-8 card">
              <div class="card-body">
                <?php echo form_open('staff/activity/checkout_confirm'); ?>
                  <form>
                    <div class="form-row">
                      <div class="col-md-12">
                      ...
                      <input type="hidden" name="activity_id" value="2">  <?php //1=Checkout ?>
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>staff/activity/checkout_info/<?php echo $user->id; ?>" class="btn btn-danger" role="button">Select</a></i></td>
                              </tr>
                            <?php } //foreach    }?>
                            </tbody>
                          </table>
      ...
      <?php }else{ ?>
        <h6 class="text-muted">Total number of registeration is <?php if(isset($users)){ echo count($users); } ?>.</h6>
        <h6 class="text-muted">Total number of check-in is <?php if(isset($checkin)){ echo count($checkin); } ?>.</h6>
        <h6 class="text-muted">Total number of check-out is <?php if(isset($checkout)){ echo count($checkout); } ?>.</h6>
        <div class="row">
          <div class="col-sm-12 card">
            <div class="card-body">
                  <div class="form-row">
                    <div class="col-md-12 table-responsive">
                      <div class="form-group">
                        <h4 class="text-success">Check-out information table.</h4>
    ...
    <div class="col-sm-3">
      <?php echo form_open('staff/activity/check_out_info'); ?>
        <form>
