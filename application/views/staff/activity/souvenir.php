...
?>
<div class="container">
  <h1 class="text-muted"><i class='fas fa-shopping-bag' style='font-size:80px;color:orange'></i> <?php echo $title; ?></h1>
  <ul class="nav nav-pills">
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Menu</a>
    <div class="dropdown-menu">
      <a class="dropdown-item" href="<?php echo base_url(); ?>staff/activity/export_souvenir" target="_blank">Export excel</a>
    </div>
  </li>
</ul>
  ...
  <div class="row">
      ...
      <?php if(isset($user)){ // ?>
          ...
          <?php } ?>
            ...
            <div class="col-sm-8 card">
              <div class="card-body">
                <?php echo form_open('staff/activity/souvenir_confirm'); ?>
                  <form>
                    ...
                    <div class="form-row">
                      <div class="col-md-12 table-responsive">
                        <div class="form-group">
                          ...
                          <br/>
                          <button type="submit" class="btn btn-outline-danger btn-lg float-right" value="confirm"><i class='fas fa-user-check' style='font-size:24px;color:red' title="Click here for confirm paid."></i> Confirm</button>
                          <br/>
                        <?php } ?>
                          <table class="table">
                            <tbody>
                      ...
                      <input type="hidden" name="activity_id" value="2">  <?php //1=souvenir ?>
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>staff/activity/souvenir_info/<?php echo $user->id; ?>" class="btn btn-danger" role="button">Select</a></i></td>
                              </tr>
                            <?php } //foreach    }?>
                            </tbody>
                          </table>
      ...
      <?php }else{ ?>
        <div class="card-columns">
          ...
          <div class="card bg-success">
            <div class="card-body text-center">
              <h6 class="text-white">SOUVENIR PAID</h6>
              <h1 class="display-1 text-white"><b><?php if(isset($souvenir)){ echo count($souvenir); } ?></b></h1>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12 card">
            <div class="card-body">
                  <div class="form-row">
                    <div class="col-md-12 table-responsive">
                      <div class="form-group">
                        <h4 class="text-success">Check-souvenir information table.</h4>
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php
                                $status = $this->Activity_model->count_attendance_same(2,$user->member_id);
                                if($status > 0) {
    ...
    <div class="col-sm-3">
      <?php echo form_open('staff/activity/check_souvenir_info'); ?>
        <form>
