...
?>
<div class="container">
  <h1 class="text-muted"><i class='fas fa-bus-alt' style='font-size:80px;color:orange'></i> <?php echo $title; ?></h1>
  <ul class="nav nav-pills">
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Menu</a>
      <div class="dropdown-menu">
        <a class="dropdown-item" href="<?php echo base_url(); ?>staff/activity/export_fieldtrip_go/<?php echo $activity_id.'/2019-12-19'; ?>" target="_blank">Export Data Go</a>
        <a class="dropdown-item" href="<?php echo base_url(); ?>staff/activity/export_fieldtrip_back/<?php echo $activity_id.'/2019-12-20'; ?>" target="_blank">Export Data Back</a>
      </div>
    </li>
  </ul>
  ...
  <div class="row">
        ...
        <div class="col-sm-12">
          <div class="card-columns">
            ...
            <div class="card bg-success">
              <div class="card-body text-center">
                <h6 class="text-white">GO</h6>
                <h1 class="display-1 text-white"><b><?php if(isset($go)){ echo count($go); } ?></b></h1>
              </div>
            </div>
            <div class="card bg-warning">
              <div class="card-body text-center">
                <h6 class="text-white">BACK</h6>
                <h1 class="display-1 text-white"><b><?php if(isset($back)){ echo count($back); } ?></b></h1>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <div class="card-body">
                <div class="form-row">
                  <div class="col-md-12 table-responsive">
                    <div class="form-group">
                      <h4 class="text-success">Table of status "Go".</h4>
                      <table class="table table-hover">
                        <thead>
                          <tr>
                            <th>no</th>
              ...
              <div class="col-sm-12">
                <div class="card-body">
                  <div class="form-row">
                    <div class="col-md-12 table-responsive">
                      <div class="form-group">
                        <h4 class="text-warning">Table of status "Back".</h4>
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              <th>no</th>
    ...
    <div class="col-sm-4 card">
      <?php echo form_open('staff/activity/fieldtrip_info'); ?>
      <?php
      /* input text Hidden */
      $data_hidden = array(
    ...
    <div class="row">
      ...
      <h5 class="text-muted">&nbsp;Check registration staff TJSIF2019. Please check the member details before authorize.(scan 1 time = Go, 2 time = Back, 3 = Go and Delete Back)</h5>
    </div>
