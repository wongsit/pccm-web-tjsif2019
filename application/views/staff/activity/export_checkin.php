<?php
  ...
  $fileName = 'TJSIF2019_Check-in_'.$date_stamp.'.xlsx';
  ...
  $objPHPExcel->getActiveSheet()->SetCellValue('A1', 'TJSIF2019 The list of all members Check-in. Date: '.$date_time_stamp);
