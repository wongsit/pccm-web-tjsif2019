    ...
    <div class="col-sm-10">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <?php echo form_open('staff/organization/update'); ?>
            <form>
              <div class="form-row">
                <div class="col-md-8">
                ...
                <?php foreach($orgs as $org_data) { ?>
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="sister[]" value="<?php echo $org_data->id; ?>"
                          <?php for($i=0;$i<count($div);$i++){      //วนลูปเพื่อกำหนด checked
                            if($org_data->id == $div[$i]) echo 'checked';
                          } ?> > <?php echo $org_data->name; ?>
                      </label>
                    </div>
                  </div>
                </div>
