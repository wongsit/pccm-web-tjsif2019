...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      <a href="<?php echo base_url(); ?>staff/organization/new" class="btn btn-success btn-block"><i class='fas fa-plus'></i> Add Organization</a>
          ...
          <?php foreach ($orgs as $org) {  ?>
            <tr>
              <td>
                ...
                if($img_check){ ?>
                  <a href="<?php echo base_url(); ?>staff/organization/info/<?php echo $org->id; ?>">
              ...
              <td><a href="<?php echo base_url(); ?>staff/organization/info/<?php echo $org->id; ?>" class="lead"><?php echo $org->name ?></a></td>
              ...
              <td>
                ...
                <?php for($i=0;$i<count($div);$i++){      //วนลูปเพื่อกำหนด ดึงชื่อโรงเรียน
                  ...
                  <a href="<?php echo base_url(); ?>staff/organization/info/<?php echo $div[$i]; ?>" class="lead"><?php echo $o_name.'<br>'; ?></a>
                <?php } ?>
              </td>
              <td>
                <?php if($org->active) { ?>
