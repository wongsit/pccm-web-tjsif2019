  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="row">
        ...
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>staff/member/index" class="btn btn-outline-info btn-block text-left"><i class='fas fa-users'></i> View member list</a>
        </div>
        <div class="col-sm-8">
          <a href="#" class="btn btn-outline-info btn-block text-left"><i class='fas fa-calendar-check'></i> View Attendance</a>
        </div>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>staff/profile/edit/<?php echo $user->id; ?>" class="btn btn-outline-info btn-block text-left"><i class='fas fa-user-circle'></i> Edit infomation</a>
        </div>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>staff/profile/print_card/<?php echo $user->id; ?>" class="btn btn-outline-info btn-block text-left" target="_blank"><i class='fas fa-print'></i> Print member card</a>
        </div>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>staff/profile/fieldtrip/<?php echo $user->id; ?>" class="btn btn-outline-info btn-block text-left" ><i class='fas fa-map-marker-alt'></i> fieldtrip</a>
        </div>
        <div class="col-sm-8">
          <?php if($this->session->userdata('username') == 'w.khanchai@pccm.ac.th'){ ?>
          <a data-toggle="modal" data-target="#delete" href="#" class="btn btn-outline-danger btn-block">Delete member this</a>
        <?php } ?>
        </div>
      </div>
    </div>
