...
<div class="container">
  ...
  <div class="row">
    <h3 class="text-success"><b>Registeration Status Member (Participant and Observer)</b></h3>
            ...
            foreach ($orgs as $org){ ?>
              ...
              foreach ($occ_types as $occ_type){
                if(intval($occ_type->id) == 1){   //Student
                  $count_student_male[1] = $this->Users_model->users_count_occ_male_org_id_participant_observer($occ_type->id,$org->id);
                  $count_total_student_male[1] += $count_student_male[1];
                  $count_all_student_male[1] += $count_student_male[1];
                  $count_student_female[1] = $this->Users_model->users_count_occ_female_org_id_participant_observer($occ_type->id,$org->id);
                  ...
                  $count_teacher_male[2] = $this->Users_model->users_count_occ_male_org_id_participant_observer($occ_type->id,$org->id);
                  $count_total_teacher_male[2] += $count_teacher_male[2];
                  $count_all_teacher_male[2] += $count_teacher_male[2];
                  $count_teacher_female[2] = $this->Users_model->users_count_occ_female_org_id_participant_observer($occ_type->id,$org->id);
                  $count_total_teacher_female[2] += $count_teacher_female[2];
                  $count_all_teacher_female[2] += $count_teacher_female[2];
                }else{  //Other
                  $count[$occ_type->id] = $this->Users_model->users_count_occ_org_id_participant_observer($occ_type->id,$org->id);
                  $count_total[$occ_type->id] += $count[$occ_type->id]; ?>
                  <?php  $count[$occ_type->id]; $count_all[$occ_type->id] += $count[$occ_type->id]; ?>
                  <?php
                }
              }
              $count['sum'] = $this->Users_model->users_count_org_id_participant_observer($org->id);
