  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="row">
        ...
        <div class="col-sm-10">
          <a href="<?php echo base_url(); ?>members/organization/index" class="btn btn-outline-success  btn-lg  btn-block">View organization list</a>
        </div>
        <?php if($this->session->userdata('org_id') == $org->id) { ?>
        <div class="col-sm-10">
          <a href="<?php echo base_url(); ?>members/organization/upload_picture/<?php echo $org->id; ?>" class="btn btn-warning btn-lg btn-block">Change picture</a>
        </div>
        <div class="col-sm-10">
          <a href="<?php echo base_url(); ?>members/organization/edit/<?php echo $org->id; ?>" class="btn btn-primary btn-lg btn-block">Edit infomation</a>
        </div>
      <?php } ?>
      </div>
    </div>
