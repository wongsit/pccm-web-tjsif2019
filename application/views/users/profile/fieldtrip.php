  ...
  <div class="row">
    <div class="col-sm-8">
      ...
      <div class="row">
        <?php if($user->trip > 0){?>
          ...
          <div class="row">
            <div class="col-sm-4">
              <img src="<?php echo base_url(); ?>assets/images/fieldtrip/<?php echo $user->trip; ?>.jpg" class="float-left  img-responsive d-block w-100" alt="fieldtrip">
            </div>
            <div class="col-sm-8">
    ...
    ?>
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <?php echo form_open('users/profile/chose_fieldtrip'); ?>
              <form>
                <div class="form-row">
                  <div class="col-md-12">
