  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="row">
        ...
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>members/member/index" class="btn btn-outline-info btn-block text-left"><i class='fas fa-users'></i> View member list</a>
        </div>
        <div class="col-sm-8">
          <a href="#" class="btn btn-outline-info btn-block text-left"><i class='fas fa-calendar-check'></i> View Attendance</a>
        </div>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>users/profile/change_password" class="btn btn-outline-info btn-block text-left"><i class='fas fa-key'></i> Change password</a>
        </div>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>users/profile/upload_picture" class="btn btn-outline-info btn-block text-left"><i class='fas fa-photo'></i> Change picture</a>
        </div>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>users/profile/edit" class="btn btn-outline-info btn-block text-left"><i class='fas fa-user-circle'></i> Edit infomation</a>
        </div>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>users/profile/fieldtrip" class="btn btn-outline-info btn-block text-left"><i class='fas fa-map-marked-alt'></i> Chose Field Trip</a>
        </div>
        <?php if(intval($this->Users_model->fetch_active($this->session->userdata('id'))) == 1){ ?>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>users/profile/qrcode" class="btn btn-outline-info btn-block text-left"><i class='fas fa-qrcode'></i> My QR-code</a>
        </div>
      <?php }else{ ?>
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>users/profile/confirm" class="btn btn-outline-info btn-block text-left"><i class='fas fa-check'></i> Confirm Profile</a>
        </div>
      <?php } ?>
        <!--
        <div class="col-sm-8">
          <a href="<?php echo base_url(); ?>users/profile/print_card/<?php echo $user->id; ?>" class="btn btn-outline-info btn-block text-left"  target="_blank"><i class='fas fa-print'></i> Print member card</a>
        </div>
      -->
      </div>
    </div>
